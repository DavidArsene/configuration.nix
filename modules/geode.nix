	...
	options.nix-mineral = {
		...
		overrides = {
			...
			security = {
				...
				disable-amd-iommu-forced-isolation =
					l.mkOption {
						type = l.types.bool;
						default = false;
						description = ''
