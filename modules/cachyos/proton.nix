...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    url = "https://mirror.cachyos.org/repo/x86_64_v4/cachyos-znver4/proton-cachyos-1:${protonCachyosVersions.base}.${protonCachyosVersions.release}-1-x86_64_v3.pkg.tar.zst";
